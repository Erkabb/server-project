...
export const Footer = () => {
    return (
        <div className='w-full p-5 bg-[#FFFFFE] m-10 rounded-xl flex flex-col'>
            <Image src={'/rhodelogo.png'} alt='logo' width={1200} height={400}
                   className='w-full h-full border-b bg-[#FFFFFE] p-5 border-black'/>
                ...
                <div className='p-5 border-r flex flex-col border-black gap-5 text-[#7e7d7d]'>
                    ...
                    <div className='flex'>
                        <Input placeholder='Email Address'
                               className='h-[50px] rounded-s-xl bg-white rounded-e-none text-[#7e7d7d]'/>
                        <Button
                            className='w-[150px] rounded-e-xl h-[50px] rounded-s-none bg-white text-[#7e7d7d] hover:bg-[#7e7d7d] hover:text-white'>SUBSCRIBE</Button>
                    </div>
                    <p>By signing up, you agree to our <Link href={''} className='hover:underline'>Privacy
                        Policy*</Link>.</p>
                </div>
                <div className='flex justify-evenly w-full p-5 text-[#7e7d7d]'>
                    ...
                    <div>
                        ...
                        <ul className='flex flex-col gap-5'>
                            ...
                            <li><Link href={''} className='hover:underline'>Do Not Sell or Share My Personal
                                Information</Link></li>
